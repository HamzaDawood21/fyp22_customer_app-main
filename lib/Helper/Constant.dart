const String appName = 'Iconic Computer';

const String packageName = 'com.iconic.computer';
const String androidLink = 'https://play.google.com/store/apps/details?id=';

const String iosPackage = 'com.iconic.computer';
...
const String deepLinkName = 'iconic';
...
const String baseUrl = 'Add_Your_BaseUrl_Here';
